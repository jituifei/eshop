...
$sql = "select *FROM user WHERE del=0  LIMIT $currentPageFirst,$everyNum";
$page=$_SESSION["page"];
...
?>
        ...
        <div class="col-sm-9   col-md-8 col-md-offset-3  main">
            ...
            <h3 class="sub-header">当前位置：<strong>用户管理</strong></h3>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr >
                        ...
                        <th ><?php echo $row['regi_date'] ?> </th>
                        <th ><?php echo $row['account'] ?> </th>
                        <th><a href="user_update.php?id=<?php echo $row["id"]?>">修改/详情</a></th>
                        <th><a href="user_del.php?id=<?php echo $row["id"]?> ">删 除</a></th>
                ...
                <input disabled=""  id="btn_prep" type="button"  class="btn btn-default  btn-primary"
                       value="上一页" onclick="javascrtpt:window.location.href='user_manager.php?btn=-1'">
                <input disabled=""  id="btn_next" type="button" class="btn btn-default  btn-primary"
                       value="下一页" onclick="javascrtpt:window.location.href='user_manager.php?btn=1'">
