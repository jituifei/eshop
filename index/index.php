...
<head>
    ...
    <link href="index css/content.css" rel="stylesheet" type="text/css" />
    <link href="index css/goods.css" rel="stylesheet" type="text/css" />
    <link href="index css/bottom.css" rel="stylesheet" type="text/css" />
    <link href="index css/suspend_part.css" rel="stylesheet" type="text/css" />
    ...
    <script src="index js/jquery-1.9.1.js"></script>
...
<div class="header_mostTop">
    <div class="mostTop_container">
        <a class="container_welcome" href="#" id="nav_welcome">Hi,欢迎来到天猫</a>
        <a class="container_welcome" href="loginPage.html">请登录</a>
        <a class="container_welcome" href="signUp.html">免费注册</a>

        <ul class="mostTop_nav">
            <li class="mostTop_navItem"><a href="#">我的淘宝</a></li>
            <li class="mostTop_navItem" id="nav_consider"><a href="#"> 我关注的品牌</a></li>
            <li class="mostTop_navItem" id="nav_showCar"><a href="#"> 购物车 </a></li>
...
<div class="content_main_logo">
    <div class="showLogo_container">
        <ul class="showLogo_list">
            ...
            <li class="showLogo_item" style="display:none"><a href="#"><img src="index img/advertisement7.jpg" /></a></a></li>
        </ul>  <!-- 自动切换的logo-->
        ...
        <ul class="channel_listShow">
            <li>
                <a href="#" class="channel_item">
                    ...
                    <p class="channel_itemTitle_sub " id="kidsAbaby">精明麻麻的选择</p>
            ...
            <li>
                <a href="#" class="channel_item">
                    ...
                    <p class="channel_itemTitle_sub" id="kidsAbaby">办公新时尚</p>
            ...
            <li>
                <a href="#" class="channel_item">
                    ...
                    <p class="channel_itemTitle_sub" id="kidsAbaby">专注婴儿车85年</p>
            ...
            <li>
                <a href="#" class="channel_item">
                    ...
                    <p class="channel_itemTitle_sub" id="kidsAbaby">亲子互动好礼物</p>
            ...
            <li>
                <a href="#" class="channel_item">
                    ...
                    <p class="channel_itemTitle_sub" id="kidsAbaby">天然免疫不上火</p>
            ...
            <li>
                <a href="#" class="channel_item">
                    ...
                    <p class="channel_itemTitle_sub" id="kidsAbaby">精美礼盒4条装</p>
